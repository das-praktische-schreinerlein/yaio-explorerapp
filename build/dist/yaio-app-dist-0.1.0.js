...
yaioApp.controller('NodeChartCtrl', function($rootScope, $scope, $routeParams, yaioUtils) {
    ...
    /**
     * generate a chart with (planned start, planned end, started and done) for +-15 days around $scope.chartOptions.baseDate
    ...
    /**
     * generate a chart with (planned start, planned end, started and done) for +-4 weeks around $scope.chartOptions.baseDate
     * @param {String} chartDivSelector   jquery-selector to add the chart on
     */
    ...
    /**
     * generate a chart with (planned start, planned end, started and done) for +-6 month around $scope.chartOptions.baseDate
     * @param {String} chartDivSelector   jquery-selector to add the chart on
     */
     ...
     * @param {Object} chartColumn   object with fields: dataColumn, filterConfig, dataPointState,
